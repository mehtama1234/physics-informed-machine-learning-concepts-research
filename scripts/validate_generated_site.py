...
def check_required_sections() -> list[str]:
    required = {
        "site/handoff.html": ("Review Now", "http://127.0.0.1:8022/hand-polish.html", "Start Here", "Remote Verification Commands", "git push -u origin main", "Remaining Editorial Work"),
