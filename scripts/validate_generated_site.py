...
MEATY_GOAL_REQUIREMENT_COUNT = 32
...
def validate() -> None:
    ...
    if len(manifest) != 229:
        errors.append(f"expected 229 pages, found {len(manifest)}")
