...
def check_required_sections() -> list[str]:
    required = {
        ...
        "site/topics/operator-learning.html": ("Concrete Wrong-Use Example", "Test That Catches It", "Mathematical Sketch", "Field To Field", "Kept Rule"),
        "site/topics/surrogate-modeling.html": ("Concrete Wrong-Use Example", "Test That Catches It", "Mathematical Sketch", "Fast Stand-In", "Failure Case"),
        ...
        "site/topics/physics-informed-neural-networks.html": ("First-Principles Essay", "What A Strong Explanation Must Say", "Concrete Wrong-Use Example", "Test That Catches It", "Selected Source Anchors", "Claim Anchored", "Limit:"),
