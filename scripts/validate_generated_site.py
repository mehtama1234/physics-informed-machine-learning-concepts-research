...
MEATY_GOAL_REQUIREMENT_COUNT = 23
...
def validate() -> None:
    ...
    if len(manifest) != 224:
        errors.append(f"expected 224 pages, found {len(manifest)}")
