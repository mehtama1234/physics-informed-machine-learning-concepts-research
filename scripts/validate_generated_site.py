...
MEATY_GOAL_REQUIREMENT_COUNT = 45
...
def check_required_sections() -> list[str]:
    required = {
        ...
        "site/meaty-goal-coverage.html": ("Meaty Goal Coverage Audit", "First Principles", "Big Picture Claim Chain", "End-To-End Use Protocol", "Before The Math Slow Walk", "Teach From Zero", "Application Claim Ladder", "From Scratch Story", "No-Jargon Translation", "Plain Retell Drill", "Field Transfer Check", "Wrong Path Repair", "Course Bridge", "Use Or Refuse Gate", "Final Learner Proof", "Next-Day Memory Check", "Nearby Topic Comparison", "Math Shape Rehearsal", "Source-To-Claim Boundary", "Field Mini Cases", "Plain Question To Answer Script", "Know And Still Test", "Failure Consequence", "Slow Problem Shape Bridge", "Plain Big Picture Essay", "Slow Importance Essay", "Long Everyday Importance Essay", "Hand Teaching Note", "Case Walkthrough", "Course Role", "Concept Connections", "Belief Evidence", "Domain Fit", "Shape Follows", "Formula Terms", "Breaks Without Idea", "Reader Answer Parts", "Say It Back Check", "Misread Repair Drill", "Plain-Language Audit", "Acceptance Sentence", "Missing Items"),
