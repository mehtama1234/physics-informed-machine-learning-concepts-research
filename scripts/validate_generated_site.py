...
def check_required_sections() -> list[str]:
    required = {
        ...
        "site/meaty-goal-coverage.html": ("Meaty Goal Coverage Audit", "First Principles", "Case Walkthrough", "Concept Connections", "Belief Evidence", "Formula Terms", "Acceptance Sentence", "Missing Items"),
        "site/diagrams.html": ("Mathematical Sketches", "Kept Rule", "Failure Case"),
        "site/topics/operator-learning.html": ("One Concrete Case From Start To Finish", "Observed Evidence", "Rejection Test", "How This Connects To Nearby Ideas", "Learn Before This", "Confusion It Prevents", "Evidence Needed To Believe This", "Strong Evidence", "Too Weak", "Reject Or Recheck When", "Plain Formula Term By Term", "What It Carries", "Concrete Worked Example", "Concrete Wrong-Use Example", "Test That Catches It", "Acceptance Sentence Filled", "I would test it by changing", "Mathematical Sketch", "Field To Field", "Kept Rule"),
...
def check_meaty_goal_coverage() -> list[str]:
    ...
    for row in rows:
        ...
        if len(row.get("requirements") or []) != 11:
