...
MEATY_GOAL_REQUIREMENT_COUNT = 69
...
def check_required_sections() -> list[str]:
    required = {
        ...
        "site/video-study-guide.html": ("2025 Video-By-Video Study Guide", "What this video is doing", "Main Points Discussed", "First-principles point", "Do not worry about this yet", "Lecture 1 Course Introduction", "Lecture 14"),
        "site/videos/eth-aise-2025-001-eth-zrich-aise-2025-lecture-1-course-introduction.html": ("Video Study Note", "Plain title", "What the course is trying to do", "Main Points Discussed", "Open the 2025 video-by-video study guide"),
...
def validate() -> None:
    ...
    if len(manifest) != 233:
        errors.append(f"expected 233 pages, found {len(manifest)}")
