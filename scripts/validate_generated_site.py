...
def check_required_sections() -> list[str]:
    required = {
        ...
        "site/families/physics-constraints-family.html": ("Family Story From First Principles", "Concrete Family Case", "Why The Concepts Appear In This Order", "Evidence Chain To Track", "What Each Concept Does In The Family", "Evidence Needed Before Trusting The Family", "Too Weak"),
        "site/families/neural-operators-family.html": ("Family Story From First Principles", "Concrete Family Case", "Why The Concepts Appear In This Order", "Evidence Chain To Track", "What Each Concept Does In The Family", "Evidence Needed Before Trusting The Family", "Too Weak"),
        ...
        "site/derivations/physics-informed-neural-networks.html": ("Hand Derivation", "Why It Enters", "Final Line", "Why This Shape And Not Another", "Observed Burden", "Rejection Burden"),
        "site/derivations/operator-learning.html": ("Hand Derivation", "Why It Enters", "Final Line", "Why This Shape And Not Another", "Observed Burden", "Rejection Burden"),
